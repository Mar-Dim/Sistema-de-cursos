...
const create_embeddedQuestion_dto_1 = require("../../question/dto/create-embeddedQuestion.dto");
...
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsEnum)(lesson_entity_1.LessonType, { message: 'Type solo puede ser de tipo vocabulario, gramtica, listening o practica' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => create_embeddedQuestion_dto_1.CreateEmbeddedQuestionDto),
